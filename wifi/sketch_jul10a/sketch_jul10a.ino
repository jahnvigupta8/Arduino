...
const int trigPin = 10;            // Making the arduino's pin 8 as the trig pin of ultrasonic sensor10
const int echoPin = 13;            // Making the arduino's pin 9 as the echo pin of the ultrasonic sensor
